...
* Illusionen bestehen unabhängig von inter-individuellen Unterschieden

* Illusionen können durch neuronales Geschehen (zum Teil) erklärt werden
...
* Mit bildgebenden Verfahren können wir sogar herausfinden, welche Prozesse im Gehirn ablaufen, wenn wir Schmerzen erleben.
...
##### Das schwierige Problem des Bewusstseins (David Chalmers, 1995)
...
* Um sich einer Sache bewusst zu sein, muss sich das Gehirn in einem relativ hohen Erregungszustand befinden (Vigilanz) befinden (Wachzustand, REM-Schlaf)
...
* Kliniker: Bewertungssysteme wie die 
